...
#result_name = 'S_result'
#result_name = 'observables_result'
#result_name = 'observables_distribution_aver'
    ...
    for boundary in boundary_dirs:
        ...
        for velocity in velocity_dirs:
            ...
            for beta in beta_dirs:
                log_path = f'{base_path}/{lattice_size}/{boundary}/{velocity}/{beta}/{result_name}.csv'
...
df.to_csv(f'{base_path}/{result_name}_summary.csv', index=False)
