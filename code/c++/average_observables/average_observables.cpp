...
int main() {
  ...
  for (int cut = 0; cut < 5; cut++) {
    ...
    start_time = omp_get_wtime();
    // auto result =
    //     df.groupby1<int>("conf_end", hmdf::LastVisitor<int>(),
    //                      std::make_tuple("S", "S", MeanVisitor()),
    //                      std::make_tuple("Jv", "Jv", MeanVisitor()),
    //                      std::make_tuple("Jv1", "Jv1", MeanVisitor()),
    //                      std::make_tuple("Jv2", "Jv2", MeanVisitor()),
    //                      std::make_tuple("Blab", "Blab", MeanVisitor()),
    //                      std::make_tuple("E", "E", MeanVisitor()),
    //                      std::make_tuple("Elab", "Elab", MeanVisitor()),
    //                      std::make_tuple("Bz", "Bz", MeanVisitor()),
    //                      std::make_tuple("Bxy", "Bxy", MeanVisitor()),
    //                      std::make_tuple("Ez", "Ez", MeanVisitor()),
    //                      std::make_tuple("Exy", "Exy", MeanVisitor()),
    //                      std::make_tuple("ElabzT", "ElabzT", MeanVisitor()),
    //                      std::make_tuple("ElabxyT", "ElabxyT",
    //                      MeanVisitor()), std::make_tuple("Ae", "Ae",
    //                      MeanVisitor()), std::make_tuple("Am", "Am",
    //                      MeanVisitor()), std::make_tuple("AlabeT", "AlabeT",
    //                      MeanVisitor()));
    auto fut = df.groupby1_async<int>(
